namespace MSharp.Framework.Data
{
    ...
    static class EntityFinder
    {
        ...
        internal static IEnumerable<Type> FindPossibleTypes(Type baseType, bool mustFind)
        {
            return PossibleTypesCache.GetOrAdd(baseType, t => SearchForPossibleTypes(t, mustFind));
        }
        ...
        {
            return GetDomainEntityTypes().FirstOrDefault(x => x.FullName == typeFullName);
        }
