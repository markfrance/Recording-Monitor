...
namespace System
{
    public sealed class Base32Integer
    {
        ...
        private static string ValidChars = "1AZ2WSX3" + "EDC4RFV5" + "TGB6YHN7" + "UJM8K9LP";
        ...
        {
            Value = FromBase32String(base32Integer);
        }

        public override string ToString()
        {
            return ToBase32String(Value);
        }
        ...
        public static int FromBase32String(string valueString)
        {
            ...
            for (var figureIndex = valueString.Length - 1; figureIndex >= 0; figureIndex--)
            {
                ...
                //r += (int)Math.Pow(32, valueString.Length - figureIndex) * figureValue;
        ...
        public static implicit operator int(Base32Integer value)
        {
            return value.Value;
        }
