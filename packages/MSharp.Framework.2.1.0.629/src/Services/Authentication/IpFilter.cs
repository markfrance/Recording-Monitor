namespace MSharp.Framework.Services
{
    ...
    public class IpFilter
    {
        ...
        static FileInfo CountryIpsFile = AppDomain.CurrentDomain.GetPath("App_Data\\IPBlock\\dbip-country.csv").AsFile();
        ...
        public static Action OnBlockedAccessAttempt = EndWithMessage;
        ...
        static void EndWithMessage()
        {
            HttpContext.Current.Response.EndWith(BlockedAttemptResponse);
        }

        static void LoadBlockedIpRanges()
        {
            var table = CsvReader.Read(CountryIpsFile, isFirstRowHeaders: false);
