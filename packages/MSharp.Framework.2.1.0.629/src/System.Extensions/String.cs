namespace System
{
    ...
    partial class MSharpExtensions
    {
        ...
        public static string TrimStart(this string text, string textToTrim)
        {
            ...
            {
                return text.Substring(textToTrim.Length).TrimStart(textToTrim);
            }
            else
            {
                return text;
        ...
        public static bool IsNoneOf(this string text, params string[] items)
        {
            return !text.IsAnyOf(items);
        }

        /// <summary>
        /// Returns a copy of this text converted to lower case. If it is null it will return empty string.
        /// </summary>
        public static string ToLowerOrEmpty(this string text)
        {
            return text.OrEmpty().ToLower();
        }

        /// <summary>
        /// Returns a copy of this text converted to upper case. If it is null it will return empty string.
        /// </summary>
        public static string ToUpperOrEmpty(this string text)
        {
            return text.OrEmpty().ToUpper();
        }
        ...
        public static string EnsureStart(this string text, string startText, bool caseSensitive = false)
        {
            if (startText.IsEmpty())
                throw new ArgumentNullException("startText");
        ...
        /// </summary>
        public static string ToHtmlLines(this string text)
        {
            return text.OrEmpty().ToLines().ToString("<br/>");
        }

        /// <summary>
        /// Will join all items with a BR tag and return the result as a raw html.
        /// </summary>
        public static string ToHtmlLines<T>(this IEnumerable<T> items)
        {
            return items.ToString("<br/>");
        }
        ...
        static string GetRegularPlural(string singular)
        {
            ...
            if (ending == 's' || (secondEnding.ToString() + ending.ToString()) == "ch" || (secondEnding.ToString() + ending.ToString()) == "sh")
            {
                return singular + "es";
            }
            else if (ending == 'y' && secondEnding != 'a' && secondEnding != 'e' && secondEnding != 'o' && secondEnding != 'i' && secondEnding != 'u')
            {
        ...
        {
            if (times < 0) throw new ArgumentOutOfRangeException("times", "times should be 0 or more.");
        ...
        public static string Remove(this string text, params string[] substringsToExclude)
        {
            ...
            foreach (var sub in substringsToExclude.Where(x => x.HasValue()))
        ...
        public static bool IsAnyOf(this char character, params char[] characters)
        {
        ...
        {
            return LacksAll(text, caseSensitive: false, phrases: phrases);
        }
        ...
        public static bool LacksAll(this string text, bool caseSensitive, params string[] phrases)
        {
            ...
            if (phrases.Any(p => p.HasValue() && text.Contains(p, caseSensitive)))
            {
                return false;
            }
            else
        ...
        #region ToLiteralFromPascalCase
        ...
        {
            return list.ExceptNull().Select(i => i.ToUpper());
        }
        ...
        public static byte[] ToBytesWithSignature(this string text, Encoding encoding)
        {
            if (encoding == Encoding.UTF8)
                return GetUtf8WithSignatureBytes(text);
            else
        ...
        /// </summary>
        public static IO.FileInfo AsFile(this string path) => new IO.FileInfo(path);

        /// <summary>
        /// Converts this path into a Uri object.
        /// </summary>
        public static Uri AsUri(this string path)
        {
            return new Uri(path);
        }
        ...
        public static string XmlDecode(this string text)
        {
            ...
            return System.Security.SecurityElement.FromString(text).ToString();
        }
        ...
        {
            return Substring(text, from, to, inclusive, caseSensitive: true);
        }
        ...
        public static string Substring(this string text, string from, string to, bool inclusive, bool caseSensitive)
        {
            ...
            var toIndex = text.IndexOf(to, fromIndex + 1, comparison);
        ...
        {
            return new string(clearText.CreateSHA1Hash().ToCharArray().Where(c => c.IsLetterOrDigit()).ToArray());
        }
        ...
        {
            T value;
            if (Enum.TryParse(text, ignoreCase: true, result: out value)) return value;
        ...
        /// </summary>
        private static readonly char[] JsUnsafeCharacters = new[] { '\'', '\"' };
        ...
        ///// <summary>
        ///// E.g. converts &quot;hell.o tHere_Mr@&quot; to &quot;HelloThereMr&quot;
        ///// </summary>
        //public static string ToPascalCaseFromLiteral(this string text)
        //{
        ...
        //        if (Char.IsLetter(c))
        //        {
        //            sb.Append(startWord ? Char.ToUpper(c) : Char.ToLower(c));
        ...
        public static string ToPascalCaseId(this string text)
        {
            ...
            return new MSharp.Framework.Services.IdentifierGenerator(text).Build();
        }
        ...
        /// </summary>
        public static string TrimBefore(this string text, string search, bool caseSensitive = false)
        {
            if (text.IsEmpty()) return text;
        ...
        {
            return ToString(value, trueText, falseText, nullText: null);
        }
