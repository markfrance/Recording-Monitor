...
namespace System
{
    partial class MSharpExtensions
    {
        ...
        //public static bool Contains(this IEnumerable list, object item)
        //{
        //    if (list == null) return false;


        //    foreach (var i in list)
        //        if (i.Equals(i)) return true;
        ...
        public static bool Any<T>(this IEnumerable<T> list, Func<T, int, bool> predicate)
        {
        ...
        /// </summary>        
        public static bool Lacks<T>(this IEnumerable<T> list, T item)
        {
        ...
        {
            return list.OrderBy(i => keySelector(i)).FirstOrDefault();
        }
        ...
        {
            return list.ContainsAny(ids.Where(x => x != null).ToArray());
        }
