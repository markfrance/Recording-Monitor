namespace System
{
    partial class MSharpExtensions
    {
        ...
        {
            return "{0:c}".FormatWith(value).TrimEnd(".00");
        }
        ...
        /// </summary>
        public static DateTime ToDateFromOA(this double value)
        {
        ...
        public static DateTime? ToDateFromOA(this double? value)
        {
            ...
            else return DateTime.FromOADate(value.Value);
        }
        ...
        public static decimal AsPercentageOf(this decimal value, decimal total, bool multiplyBy100 = true, int? roundTo = null)
        {
            ...
            if (roundTo.HasValue)
                pc = decimal.Round(pc, roundTo.Value);
        ...
        /// </summary>
        public static double RoundDownToNearest(this double value, double roundIntervals)
        {
            return value - (value % roundIntervals);
        }

        /// <summary>
        /// Rounds down to nearest value with the intervals specified.
        /// </summary>
        public static decimal RoundDownToNearest(this decimal value, decimal roundIntervals)
        {
            return value - (value % roundIntervals);
        }
